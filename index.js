...
function customAssign(...objects) {
  ...
  //   } else {
  //     let newObject = Object.assign({}, objects);
...
function customObjectFromEntries(entries) {
  ...
  //   const mapNotification = entries.map(([key, value]) => {
  ...
  //     }
  //   });
  //   const and = Object.fromEntries(mapNotification);
  //   return and;
...
function extendAndFreezeObject(obj1, obj2) {
  ...
  // Використовуємо метод Object.assign() для додавання властивостей obj2 до obj1
    ...
    let cloneObj = Object.assign(obj1, obj2);
...
function filterObjectsByKey(arr, key) {
  ...
  if (!Array.isArray(arr)) {
    ...
    return arr.filter((k) => k.hasOwnProperty(key));
  }
}
...
function checkOwnership(obj1, obj2, key) {
  ...
  if (obj1.hasOwnProperty(key) && obj2.hasOwnProperty(key)) {
    return obj1.values === obj2.values;
  }
...
function getObjectValuesSum(obj) {
  ...
  if (!Object(obj)) {
    ...
    let result = sum.reduce((a, b, c) => a + b + c);
    // Повертаємо суму
    return result;
  }
}
